...
# ASI02:2026 Tool Misuse & Exploitation — all tools are READ-ONLY SQLite queries
# (query_rates, query_branch). No write, delete, or transfer operations exist.
# This constrains the blast radius: even if an injection bypasses the guard,
# the agent cannot modify data, send funds, or exfiltrate via tool calls.
